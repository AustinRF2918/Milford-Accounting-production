   ...
   <div class="bg-pages">                                                                       
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="windowLabel">Email Sent!</h4>
                </div>
                <div class="modal-body">
                    <p>Your email was sent to Milford Accounting.</p>
                </div>
                <div class="modal-footer">
                </div>
                <div class="text-xs-center m-y-2">
                <button class="btn btn-primary text-xs-center" id="btn-dismiss">Okay</button>
                </div>
            </div>
        </div>
	...
	<div class="row">
		...
		<form name="sentMessage" id="contactForm" novalidate method="post" action="contactresponse.php">
			...
			<button type="submit" class="btn btn-cta btn-block  m-t-1 block-center" data-toggle="modal" data-target="#window">Submit</button>
		    </div>
		</form>
	    </div>
    </div>
